...
function TabContentInbox(props) {
  return (
    <div className="data">
      {props.tabContent[props.tabController()].length == 0 && (
        <div className="no-content mediumRegular">
          {props.onFetching == true ? (
            <p>Loading...</p>
          ) : (
            <div>
              <img src={noEmail} alt="" /> You don't have any{" "}
              {props.tabController()} mails.{props.onFocus}
            </div>
          )}
        </div>
      )}
      {props.tabContent[props.tabController()].map((e, index) => {
        return (
          <motion.div
            ...
            key={index}
            className={`mail-data ${
              props.selectionId.includes(e.index) ? "mail-data-selected" : ""
            }`}
          >
            <div className="mail-data-start">
              <span
                className="material-symbols-outlined"
                style={props.onSelect ? { color: "rgb(255,86,63)" } : {}}
                onClick={() => {
                  props.setOnSelect(true);
                  props.setSelectionId([...props.selectionId, e.index]);
                  if (props.onSelect) {
                    if (props.selectionId.includes(e.index)) {
                      const newArray = props.selectionId.filter(function (
                        item
                      ) {
                        return item !== e.index;
                      });
              ...
              >
                {props.selectionId.includes(e.index)
                  ? "check_box"
            ...
            >
              <span className="boldSans">{e.markdown.substring(0, 23)}</span> -{" "}
              <span className="opp">{e.markdown}</span>
            </p>
            <p
...
function TabContentGeneral(props) {
  ...
  return (
    <div className="data">
      {tabContentController[name()].length == 0 && (
        <div className="no-content mediumRegular">
          <img src={noEmail} alt="" />
        ...
        return (
          ...
          >
            ...
            <p className="mediumRegular mark">
              <span className="boldSans">{e.markdown.substring(0, 23)}</span> -{" "}
              <span className="opp">{e.markdown.slice(-56)}...</span>
            </p>
      ...
      <div className="bodyMain">
        <div className="SideNav">
          ...
          <button
            ...
            className={`${
              menuToggle ? "composeToggle" : "compose"
            } mediumRegular`}
          >
              ...
              <div className={`${onFocus == true ? "input-focus" : ""} input`}>
                <img
                  ...
                  onClick={() => {
                    if (searchValue.trim().length != 0) {
                      if (index == 0) {
                        const filtered = props.inbox.filter(
                          (item) =>
                            item.subject
                              .toLowerCase()
                ...
                <input
                  ...
                  onFocus={() => {
                    ...
                    const res = suggestion.filter((element) =>
                    ...
                    if (refSuggestion.current != null) {
                      refSuggestion.current.innerHTML =
                        refSuggestion.current.innerText
                          .toLowerCase()
                    ...
                    if (index == 1) {
                      const filtered = props.star.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
                    ...
                    if (index == 2) {
                      const filtered = props.sent.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
                    ...
                    if (index == 3) {
                      const filtered = props.archive.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
                    ...
                    if (index == 4) {
                      const filtered = props.spam.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
                    ...
                    if (index == 6) {
                      const filtered = props.unread.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
                    ...
                    if (index == 7) {
                      const filtered = props.read.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
                    ...
                    if (index == 8) {
                      const filtered = props.trash.filter(
                        (item) =>
                          item.subject
                            .toLowerCase()
                            .includes(searchValue.toLowerCase().trim()) ||
            ...
            <div className="toolBox">
              <div className="wallet-info">
                <div className="wallet-info-address">
                  {props.user.substring(0, 4) + "..." + props.user.slice(-4)}
                </div>
                <div className="modal">
                  <div className="top">
                    <div className="img">
                  ...
                  <div className="domain">
                    <div>
                      NFT: <span>Comming soon</span>
                    </div>
                  </div>
                  <div className="domain">
                    <div>
                      GameFi: <span>Comming soon</span>
                    </div>
                  </div>
                  <div className="domain">
                    <div>
          ...
          <div className="header">
            <div className="header-tools">
              ...
              >
                ...
                {selected == null && (
                  <span
                    style={onSelect ? { color: "rgb(255,86,63)" } : {}}
                    onClick={() => {
                      if (selected == null) {
                ...
                {onSelect && (
                  <button
                    ...
                    className={`bulk mediumSans ${
                      selectionId.length == 0 ? "bulk-inactive" : ""
                    }`}
                  >
                    <span className="material-symbols-outlined">
                      fingerprint
              ...
              <div className="tab-details">
                <p className="mediumSans">
                  1-50 of {/*tabContent[tabController()].length*/}
                </p>
                <span
                  onClick={() => {
                    if (tab > 0) {
            ...
            {selected != null && (
              ...
              >
                ...
                <div>
                    ...
                    <div className="details-body-ceil">
                      ...
                      <div>
                        ...
                        <p className="to-h mediumRegular">
                          {props.user.toString().toLowerCase() ===
                          selected.sender.toString().toLowerCase()
                            ? "Me"
                            : "View the sender"}
                        </p>
                      </div>
                  ...
                  <pre className="text-body">{selected.markdown}</pre>
                </div>
                ...
                {dataReply.map((el, key) => {
                  return (
                    ...
                    >
                      <div className="details-body">
                        <div className="details-body-ceil">
                          ...
                          <div>
                            ...
                            <p className="to-h mediumRegular">
                              {props.user.toString().toLowerCase() ===
                              el.sender.toString().toLowerCase()
                                ? "Me"
                                : "View the sender"}
                            </p>
                          </div>
                      ...
                      <pre className="text-body">{el.markdown}</pre>
